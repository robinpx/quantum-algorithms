...
# Qiskit Code 
# https://github.com/Qiskit/qiskit-terra/blob/7bc7f08bf64aa686694467e8f8be551e0b740213/qiskit/circuit/random/utils.py
...
circ = random_circuit(5, 5, max_operands=3,measure=True)
circ.draw(output='mpl')
